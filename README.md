...
# What it is
Social media app for bookworms where book lovers can connect with likeminded readers.
...
<p align="left">
  <img src="docs/HighLevel_Architecture_Kubernetes.svg" alt="architecture" width="120%">
</p>
