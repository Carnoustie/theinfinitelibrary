...
The database is of the mysql variety, and assuming mysql is installed, create the database and its schema by running `mysql -u <your_mysql_username> -p theinfinitelibrary < schemas_theinfinitelibrary.sql`, after which you will be prompted for your mysql password. The created mysql database is now named *theinfinitelibrary*.
