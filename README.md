...
The database is of the mysql variety, and assuming mysql is installed, create the database and its schema by running
`mysql -u <your_mysql_username> -p theinfinitelibrary < schemas_theinfinitelibrary.sql`,
